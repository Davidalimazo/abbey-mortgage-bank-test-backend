...
exports.seed = async function seed(knex) {
	await knex("posts").insert([
		{
			userId: "3168001f-903e-4f37-b320-0a0c757def9e", // Matches userId from users table
		...
		{
			userId: "92b9b12a-4dcc-4325-9da0-054f81dc9f90", // Matches userId from users table
