...
class PostingRepository{
  ...
  try {
    ...
    const sql = `INSERT INTO POSTING_HISTORY (
      PERSONNEL_NO,
      SERIAL,
      NAME,
      UNIT_FROM,
   ...
   return error.message;
    ...
    async findPostingByPersonalNo(personalNo:string){
        ...
        try {
            ...
            const sql = `SELECT * FROM POSTING_HISTORY WHERE PERSONNEL_NO = ${personalNo}`;
    ...
    async findCurrentPosting(personalNo:string){
        ...
        try {
            ...
            const sql = `SELECT *
            FROM posting_history where personnel_no=${personalNo}
...
async findAllPosting(){
  ...
  try {
      const sql = `SELECT * FROM POSTING_HISTORY`;
